    ...
    <section className="relative min-h-screen pt-28 pb-12 flex items-center justify-center bg-white dark:bg-slate-950 overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            Dites adieu aux{" "}
            <span className="text-lime-400 bolder px-2xl">cafards</span>,{" "}
            <span className="text-lime-400  px-2xl">rats</span>,{" "}
            <span className="text-lime-400 px-2xl">moustiques</span>,{" "}
            <span className="text-lime-400 px-2xl">punaises de lit</span> et
            autres nuisibles. Vermine secret assure des traitements de
            dératisation et désinfection certifiés, durables et sans danger pour
            votre environnement à Yaoundé et Douala.
          </motion.p>
          ...
          >
            <div className="flex -space-x-2.5">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="w-8 h-8 md:w-9 md:h-9 rounded-full border-2 border-white dark:border-slate-950 bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-xs"
                >
                  🛡️
                </div>
              ))}
            ...
            <div>
              <div className="flex items-center gap-0.5">
                {[1, 2, 3, 4, 5].map((i) => (
                  <Star
                    key={i}
                    className="w-3.5 h-3.5 fill-lime-500 text-lime-500"
                  />
                ))}
                <span className="text-xs md:text-sm font-bold ml-1 text-slate-900 dark:text-white">
                  4.9/5
                </span>
              </div>
              <p className="text-[11px] md:text-xs text-slate-500 dark:text-slate-400">
                Plus de 350 entreprises et domiciles assainis
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center relative order-1 lg:order-2 w-full max-w-[240px] sm:max-w-[280px] md:max-w-[300px] lg:max-w-none mx-auto py-6 lg:py-0">
          ...
          >
            <div className="w-6 h-6 rounded-full bg-lime-100 text-lime-600 flex items-center justify-center text-xs font-bold">
              ✓
            </div>
            <div className="text-left">
              ...
              <p className="text-[9px] text-slate-500 dark:text-slate-400">
                Normes de sécurité phytosanitaires
              </p>
            </div>
          </motion.div>
          ...
          >
            <span className="text-[9px] tracking-widest uppercase font-light opacity-80 dark:font-bold">
              Interventions
            </span>
